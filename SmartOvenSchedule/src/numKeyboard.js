...
exports.openKeyboardTemplate = BUTTONS.Button.template(function($){ return{
		top:$.top,left:$.left, right:$.right, width:$.width, label:$.label,max:$.max, height: $.height,skin:$.skin,keyboard:$.keyboard,fieldHint:$.fieldHint,
	contents:$.contents,
