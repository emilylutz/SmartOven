...
var turkeyLabel = new Label({left:15, style:labelStyle, string: "Chicken"});
var nextLabel1 = new Label({left:195, style:nextStyle, string: "❯"});
var turkeyContainer = new Line({top:0, left:0, right:0, height:80, active:true,skin:whiteSkin, contents:[turkeyLabel, nextLabel1],
				behavior: Object.create(BUTTONS.ButtonBehavior.prototype, {
					onTap: { value:  function(button) {
						application.invoke(new Message("/schedMainToStart"));
						
						button.skin= whiteSkin
						}},
